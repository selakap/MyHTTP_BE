package org.custom.MyBackend.HTTPS;
...
public class MyHttpsBackend {
    ...
    public static void main(String[] args) {
        int port = 8020; // the port to listen on
        //curl -X GET https://localhost:8020/hardware/deviceUnit?device_type=macOs
        //curl -X GET https://localhost:8020/hardware/allDevices



        try {
            //Open a socket
            System.setProperty("javax.net.ssl.keyStore", "/Users/selakapiumal/.wum3/products/wso2am/3.2.0/full/wso2am-3.2.0/repository/resources/security/wso2carbon.jks");
            System.setProperty("javax.net.ssl.keyStorePassword", "wso2carbon");
            ServerSocketFactory serverSocketfac = SSLServerSocketFactory.getDefault();
            ServerSocket serverSocket = serverSocketfac.createServerSocket(port);
